use {
    ...
    solana_sdk::{
        ...
        vote_new::instruction::VoteInstruction,
    },
};
...
pub fn parse_sanitized_vote_transaction(tx: &SanitizedTransaction) -> Option<ParsedVote> {
    ...
    if !solana_sdk::vote_new::program::check_id(program_id) {
        return None;
    }
...
mod test {
    ...
    fn new_vote_transaction(
        ...
        let vote = Vote::new(vote_range, bank_hash);
    ...
    fn run_test_parse_vote_transaction(input_hash: Option<Hash>) {
        ...
        assert_eq!(
            vote,
            VoteTransaction::from(Vote::new(VoteRange::new(0, 42), bank_hash))
        );
        ...
        let mut vote_ix = vote_instruction::vote(
            ...
            Vote::new(VoteRange::new(0, 2), Hash::default()),
        );
