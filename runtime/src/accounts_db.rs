...
impl AccountsDB {
    ...
    fn construct_candidate_clean_keys(
        ...
        // Account for keys that weren't root yet at the time they were flushed in
    ...
    pub fn flush_accounts_cache(&self, force_flush: bool, max_clean_root: Option<Slot>) {
        ...
        // Note we don't purge unrooted slots, let the Bank::drop() implementation do cleanup
        // instead on dead banks
