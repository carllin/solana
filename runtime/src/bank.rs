...
impl Drop for Bank {
    fn drop(&mut self) {
        ...
        unsafe {
            ...
            let instruction_processor_elapsed =
                time!(ManuallyDrop::drop(&mut self.instruction_processor));

            let compute_budget_elapsed = time!(ManuallyDrop::drop(&mut self.compute_budget));
            ...
            let cost_tracker_elapsed = time!(ManuallyDrop::drop(&mut self.cost_tracker));

            let sysvar_cache_elapsed = time!(ManuallyDrop::drop(&mut self.sysvar_cache));
            ...
            datapoint_info!(
                ...
                ("transaction_error_count_elapsed", transaction_error_count_elapsed, i64),
                ("transaction_entries_count_elapsed", transaction_entries_count_elapsed, i64),
                ("transactions_per_entry_max_elapsed", transactions_per_entry_max_elapsed, i64),
                ...
                ("genesis_creation_time_elapsed", genesis_creation_time_elapsed, i64),
                ...
                ("instruction_processor_elapsed", instruction_processor_elapsed, i64),
                ("compute_budget_elapsed", compute_budget_elapsed, i64),
                ...
                ("lazy_rent_collection_elapsed", lazy_rent_collection_elapsed, i64),
                ("rewards_pool_pubkeys_elapsed", rewards_pool_pubkeys_elapsed, i64),
                ("cached_executors_elapsed", cached_executors_elapsed, i64),
                ("transaction_debug_keys_elapsed", transaction_debug_keys_elapsed, i64),
                ("transaction_log_collector_config_elapsed", transaction_log_collector_config_elapsed, i64),
                ("transaction_log_collector_elapsed", transaction_log_collector_elapsed, i64),
                ...
                ("cost_tracker_elapsed", cost_tracker_elapsed, i64),
                ("sysvar_cache_elapsed", sysvar_cache_elapsed, i64),
            );
        }
    }
}
