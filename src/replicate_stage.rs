...
impl ReplicateStage {
    ...
    fn replicate_requests(
        ...
        let last_entry_id = {
            ...
            for (i, entry) in entries.iter().enumerate() {
                println!(
                    "In ReplicateStage, Entry id: {}, height: {}",
                    entry.id, *tick_height
                );
                ...
                if let Some(max_tick_height) = max_tick_height {
                    ...
                    if *tick_height == max_tick_height {
                        ...
                        println!(
                            "tick height: {}, last_seed_height: {:?}",
                            *tick_height, ls_lock.last_seed_height
                        );
    ...
    pub fn new(
        ...
        println!("rep new: tick_height: {}", tick_height);
...
mod test {
    ...
    use ledger::{create_sample_ledger, LedgerWriter};
    use logger;
